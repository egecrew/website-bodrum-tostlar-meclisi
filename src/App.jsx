    ...
    <div className="app">
      ...
      <header className="header">
        <div className="container">
          <div className="logo">🏢 Bodrum Tostlar Meclisi</div>
        ...
        <div className="container">
          ...
          <div className="about-content">
            ...
            <div style={{marginTop: '1.5rem', padding: '1rem', backgroundColor: '#f8f9fa', borderRadius: '8px'}}>
                ...
                <br />
                <a href="https://egecrew.github.io/website-bodrum-tostlar-meclisi/" target="_blank" rel="noopener noreferrer" style={{color: '#0066cc'}}>
                  egecrew.github.io/website-bodrum-tostlar-meclisi
                </a>
              </div>
              </div>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            ...
            <div className="service-card">
              ...
              <p>Bodrum Tostlar Meclisiin büyümesine katkı sağlayacak stratejiler ve çözümler.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="contact-content">
            <div className="contact-info">
              ...
              <div className="info-item">
                ...
                <div>
                  <h3>Adres</h3>
                  <p>Dirmil, İnönü Cd. 220/A, 48400 Bodrum/Muğla, Türkiye</p>
                </div>
              </div>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-section">
              <h4>İletişim</h4>
              <p>+900545369400<br/>fuatdertsiz@gmail.com</p>
            </div>
          </div>
          <div className="footer-bottom">
            <p>&copy; 2026 Bodrum Tostlar Meclisi. Tüm hakları saklıdır.</p>
